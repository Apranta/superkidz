                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <a href="<?=base_url('relawan/add-berita')?>" class="btn btn-default"><i class="glyphicon glyphicon-plus"></i> Tambah</a><hr>
                            <table class="table table-bordered table-striped table-hover" id="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <?php endforeach; ?>
                                        <td align="center">
                                            <a href="<?=base_url('relawan/edit-berita/'.$row['id_blog'])?>" class="btn btn-info waves-effect"><i class="fa fa-edit"></i></a>
...
<script type="text/javascript">
        ...
        function delete_blog(id_blog) {
            $.ajax({
                ...
                success: function() {
                    window.location = "<?= base_url('relawan/berita') ?>";
                }
            });
        }
        </script>
