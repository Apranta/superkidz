                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <a href="<?=base_url('admin/add-berita')?>" class="btn btn-default"><i class="glyphicon glyphicon-plus"></i> Tambah</a><hr>
                            <table class="table table-bordered table-striped table-hover" id="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <?php endforeach; ?>
                                        <td align="center">
                                            <a href="<?=base_url('admin/edit-berita/'.$row['id_blog'])?>" class="btn btn-info waves-effect"><i class="fa fa-edit"></i></a>
