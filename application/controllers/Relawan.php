...
class Relawan extends MY_Controller
{
	public function __construct()
	{
		...
		$this->data['profil'] = $this->Relawan_m->get_row(['username' => $this->data['id_user']]);
	}

  public function index()
  {
		$this->data['content'] 	= 'relawan/dashboard';
		$this->data['title'] = 'Dashboard '.$this->title;
    $this->template($this->data,'relawan');
  }
	...
	public function sunting_profil()
  {
		if ($this->POST('edit'))
		{
			...
			$this->Relawan_m->update($this->data['id_user'], $this->data['entry']);
			redirect('relawan/sunting-profil');
			exit;
		}
		$this->data['kelamin'] = $this->Gender_m->get();
		$this->data['content'] 	= 'relawan/profil';
	...
	public function berita()
	{
		...
		$this->data['content'] 	= 'relawan/blog_all';
		$this->template($this->data,'relawan');
	}
	...
	public function add_berita()
	{
		...
		$this->data['content'] 	= 'relawan/add-berita';
		$this->template($this->data,'relawan');
	}
	...
	public function edit_berita()
	{
		...
		$this->data['content'] 	= 'relawan/edit-berita';
		$this->template($this->data,'relawan');
	}
}
